...
class _SignupPageState extends State<SignupPage>
  ...
  Future<void> registerUser() async {
    ...
    if (sid.isEmpty || uname.isEmpty || mail.isEmpty || pass.isEmpty) {
    ...
    final response = await AuthService.signup(sid, uname, mail, pass);
                          ...
                          children: [
                            ...
                            _LabeledField(
                              ...
                              child: TextField(
                                ...
                                decoration: _fieldDecoration(hint: "Enter your student ID"),
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: const [
        Icon(Icons.person_add_alt_1_rounded, size: 56, color: Colors.white),
        SizedBox(height: 10),
        Text(
        ...
        SizedBox(height: 6),
        Text(
          "Use your valid Student ID to sign up",
          style: TextStyle(
            color: Colors.white70,
            fontSize: 14.5,
